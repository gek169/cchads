...
#include <stdint.h>
#ifndef S3L_NEAR_PLANE_CULL
#define S3L_NEAR_PLANE_CULL 512
#endif
  ...
  S3L_Unit depth)
{
  ...
  if (depth cmp S3L_zBuffer[index] && (depth > S3L_NEAR_PLANE_CULL)) //Near plane culling. Sorta.
